#!/bin/sh
# properties = {"type": "single", "rule": "gatk4_haplotype_caller", "local": false, "input": ["output/final_bam/1102777134.final.bam"], "output": ["output/gvcf/1102777134.17.g.vcf.gz"], "wildcards": {"sample": "1102777134", "intervals": "17"}, "params": {"interval_file": "input/scatter_interval_list/*/17scattered.interval_list"}, "log": [], "threads": 1, "resources": {}, "jobid": 67, "cluster": {"project": "acc_MMAAAS", "queue": "premium", "cores": 4, "mem": 8000, "time": "6:00"}}
