#!/bin/sh
# properties = {"type": "single", "rule": "gatk4_haplotype_caller", "local": false, "input": ["output/final_bam/1102777134.final.bam"], "output": ["output/gvcf/1102777134.3.g.vcf.gz"], "wildcards": {"sample": "1102777134", "intervals": "3"}, "params": {"interval_file": "input/scatter_interval_list/*/3scattered.interval_list"}, "log": [], "threads": 1, "resources": {}, "jobid": 53, "cluster": {"project": "acc_MMAAAS", "queue": "premium", "cores": 4, "mem": 8000, "time": "04:00"}}
