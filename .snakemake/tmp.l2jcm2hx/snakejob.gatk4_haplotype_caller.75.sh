#!/bin/sh
# properties = {"type": "single", "rule": "gatk4_haplotype_caller", "local": false, "input": ["output/final_bam/1102777134.final.bam"], "output": ["output/gvcf/1102777134.25.g.vcf.gz"], "wildcards": {"sample": "1102777134", "intervals": "25"}, "params": {"interval_file": "input/scatter_interval_list/*/25scattered.interval_list"}, "log": [], "threads": 1, "resources": {}, "jobid": 75, "cluster": {"project": "acc_MMAAAS", "queue": "premium", "cores": 4, "mem": 8000, "time": "04:00"}}
