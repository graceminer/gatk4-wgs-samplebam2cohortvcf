#!/bin/sh
# properties = {"type": "single", "rule": "gatk4_haplotype_caller", "local": false, "input": ["output/final_bam/1102777134.final.bam"], "output": ["output/gvcf/1102777134.4.g.vcf.gz"], "wildcards": {"sample": "1102777134", "intervals": "4"}, "params": {"interval_file": "input/scatter_interval_list/*/4scattered.interval_list"}, "log": [], "threads": 1, "resources": {}, "jobid": 54, "cluster": {"project": "acc_MMAAAS", "queue": "premium", "cores": 4, "mem": 8000, "time": "04:00"}}
