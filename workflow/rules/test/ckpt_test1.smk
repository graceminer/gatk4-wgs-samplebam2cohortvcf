...
rule sortsam:
    input: "output/split_rg/{sample}/{i}.bam"
    output: "output/unmapped_bam/{sample}/{i}.unmapped.bam"
    shell:
        """
        module load java/1.8.0_211  python/3.5.0  gatk/4.2.0.0
...
def aggregate_input(wildcards):
    ...
    x=expand("output/unmapped_bam/{sample}/{i}.unmapped.bam",
